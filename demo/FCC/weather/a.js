  window.onload = function(){
    ...
    console.log(returnCitySN.cname.slice(3,6));
    var getCityName = remote_ip_info.city || returnCitySN.cname.slice(3,6);
    console.log(getCityName);
    var httpJuheData = "http://op.juhe.cn/onebox/weather/query?cityname=" + getCityName + "&dtype=&key=5d412953f54ff67054afd1e1f165dbf5&callback=?";
    ...
    //读取从服务器获取的json数据, 
  	$.getJSON(httpJuheData, function(json){
          ...
          window.open ("about.html", "newwindow", "height=300, width=700, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
        }

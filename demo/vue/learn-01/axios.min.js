/* axios v0.12.0 | (c) 2016 by Matt Zabriskie */ ! function(e, t) {
    ...
    return function(e) {
        ...
        l.request = f(n.prototype.request, d), l.Axios = n, l.defaults = d.defaults, l.interceptors = d.interceptors, l.create = function(e) {
            return new n(e)
        }, l.all = function(e) {
            return Promise.all(e)
        }, l.spread = r(18), i.forEach(["delete", "get", "head"], function(e) {
        ...
        function v() {
            ...
            for (var t = {}, r = 0, n = arguments.length; n > r; r++) g(arguments[r], e);
            return t
        }
        ...
        e.exports = function(e) {
            return new Promise(function(t, n) {
                try {
                    var o;
                    "function" == typeof e.adapter ? o = e.adapter : "undefined" != typeof XMLHttpRequest ? o = r(6) : "undefined" != typeof process && (o = r(6)), "function" == typeof o && o(t, n, e)
                } catch (i) {
                    n(i)
                }
            })
        ...
        e.exports = function(e, t, f) {
            ...
            var l = new XMLHttpRequest,
                ...
                m = !1;
            if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in l || u(f.url) || (l = new window.XDomainRequest, h = "onload", m = !0, l.onprogress = function() {}, l.ontimeout = function() {}), f.auth) {
                var y = f.auth.username || "",
                    w = f.auth.password || "";
                d.Authorization = "Basic " + a(y + ":" + w)
            }
            if (l.open(f.method.toUpperCase(), o(f.url, f.params, f.paramsSerializer), !0), l.timeout = f.timeout, l[h] = function() {
                    ...
                    e.timeout = f.timeout, e.code = "ECONNABORTED", t(e), l = null
            ...
            if ("setRequestHeader" in l && n.forEach(d, function(e, t) {
                ...
                }), f.withCredentials && (l.withCredentials = !0), f.responseType) try {
                l.responseType = f.responseType
            } catch (x) {
                if ("json" !== l.responseType) throw x
            }
            f.progress && ("post" === f.method || "put" === f.method ? l.upload.addEventListener("progress", f.progress) : "get" === f.method && l.addEventListener("progress", f.progress)), void 0 === p && (p = null), l.send(p)
        }
    }, function(e, t, r) {
        "use strict";
        function n(e) {
